...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        label_c1 = c1[0], c2[1]
        label_c2 = label_c1[0] + t_size[0], label_c1[1] - t_size[1] - 5
        cv2.rectangle(img, label_c1, label_c2, color, thickness=tl, lineType=cv2.LINE_AA)
        cv2.rectangle(img, label_c1, label_c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(img, label, (label_c1[0], label_c1[1] - 2),
                    cv2.FONT_HERSHEY_DUPLEX, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
