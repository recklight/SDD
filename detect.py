...
def detect(save_img=False):
    out, source, weights, view_img, save_txt, imgsz = \
        args.output, args.source, args.weights, args.view_img, args.save_txt, args.img_size
    webcam = source == '0' or source.startswith('rtsp') or source.startswith('http') or source.endswith('.txt')

    # Initialize
    signal.signal(signal.SIGINT, sgn_exit)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            distancing(people_coords, im0, dist_thres_lim=args.risk_range)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--risk-range", type=int, default=310)
    ...
    parser.add_argument('--conf-thres', type=float, default=0.87, help='object confidence threshold')
